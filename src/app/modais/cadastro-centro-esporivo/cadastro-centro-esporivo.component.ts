...
export class CadastroCentroEsporivoComponent {
  ...
  cadastrarCentros() {
    if (this.cadastroCentro.valid) {
      ...
      formData.append('contactNumber', this.cadastroCentro.get('contactNumber').value);
      formData.append('image', this.cadastroCentro.get('image').value);
      formData.append('parking', this.cadastroCentro.get('parking').value);
      formData.append('steakhouse', this.cadastroCentro.get('steakhouse').value);
      formData.append('street', this.cadastroCentro.get('street').value);
      formData.append('streetNumber', this.cadastroCentro.get('streetNumber').value);
      ...
      formData.append('neighborhood', this.cadastroCentro.get('neighborhood').value);
      const headers = new HttpHeaders().set('Authorization', `Bearer ${token}`);

      this.http.post<any>('https://rightgame-api.onrender.com/sportsCenters', formData, { headers })
        .subscribe({
          next: (data: any) => {
            location.reload();
          },
