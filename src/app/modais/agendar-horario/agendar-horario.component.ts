...
export class AgendarHorarioComponent implements OnInit {
  ...
  horarios: SelecaoHora[] = [
    { value: '06:00:00', value2: '07:00:00', viewValue: '06:00 | 07:00'},
    { value: '07:00:00', value2: '08:00:00', viewValue: '07:00 | 08:00' },
    { value: '08:00:00', value2: '09:00:00', viewValue: '08:00 | 09:00' },
  ...
  agendar() {
    this.agendarHorario = this.formBuilder.group({
      ...
      amount: [this.valorHora ,Validators.required],
      selectedDate: [null, Validators.required]  // Campo de data
    })
  }
  ...
  updateTime(selectedHora: SelecaoHora | any) {
    if (selectedHora) {
      ...
      const startTime = selectedDate.toISOString().slice(0, 10) + ' ' + selectedHora.value;
      const endTime =  selectedDate.toISOString().slice(0, 10) + ' ' + selectedHora.value2;
  ...
  agendamentoHorario(){
    if (this.agendarHorario.valid) {
      ...
      this.http
        .post<any>('https://rightgame-api.onrender.com/sportsCenters/' + this.idCentro + '/sportsCourts/' + this.idQuadra + '/reservations', body, {headers})
          .subscribe({
            next: (data: any) => {
              this._snackBar.open('Horário reservado com sucesso!', 'Fechar', {
